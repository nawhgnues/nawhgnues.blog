      ...
      <Section className="mx-auto w-full max-w-2xl space-y-8 print:space-y-4">
        <div className="flex flex-col-reverse items-center justify-between gap-4 sm:flex-row">
          <div className="flex-1 space-y-1.5 text-center sm:text-start">
            ...
            <p className="max-w-md text-pretty text-muted-foreground print:text-[12px]">{RESUME_DATA.about}</p>
          ...
          <div className="space-y-3">
            {RESUME_DATA.education.map((education) => (
              <Card key={education.school}>
                ...
                <CardContent className="mt-2 text-base print:text-[12px]">{education.degree}</CardContent>
              </Card>
            ))}
          </div>
        </Section>
